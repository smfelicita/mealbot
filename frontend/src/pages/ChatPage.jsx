        ...
        {isGuest && (
          <div className="fade-up py-4">
            <div className="bg-bg-2 border border-border rounded-xl p-6 text-center">
              ...
              <h3 className="font-extrabold text-lg mb-2">ИИ-помощник</h3>
              <p className="text-sm text-text-2 leading-relaxed mb-5">
                Подберу блюда с учётом вашего холодильника и предпочтений. Доступно после регистрации.
              </p>
              <Button className="w-full mb-2" onClick={() => navigate('/auth?mode=register')}>
                Зарегистрироваться бесплатно
              </Button>
              <Button variant="ghost" size="sm" className="w-full text-text-2" onClick={() => navigate('/auth')}>
        ...
        {!isGuest && chatMessages.length === 0 && (
          <div className="fade-up flex flex-col gap-3">
            <div className="text-center py-5">
              ...
              <p className="text-sm text-text-2 leading-relaxed max-w-xs mx-auto">
                Расскажите что хотите съесть — подберу варианты с учётом вашего холодильника
              </p>
            </div>
            {SUGGESTIONS.map(s => (
      ...
      <div className="shrink-0 flex items-end gap-2 px-3 py-2.5 border-t border-border bg-bg">
        <input
          className="flex-1 bg-bg-3 border border-border rounded-sm text-text text-[15px]
            ...
            disabled:opacity-50"
          placeholder="Спросите про блюда..."
          value={input}
